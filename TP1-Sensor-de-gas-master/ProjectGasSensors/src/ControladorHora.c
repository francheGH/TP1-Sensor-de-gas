...
volatile uint8 reloj[16] = { 32, 32, 32, 32, 1, 2, ':', 0, 0, ':', 0, 0, 32,
		32, 32, 32, '\0' }; // Arreglo de codigos ascii que corresponden la hora (para imprimir se le debe sumar el caracter '0' a cada posicion)
